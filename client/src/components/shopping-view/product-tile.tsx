...
import { BrandOptionKey, CategoryOptionKey } from "@/types/config/index.types";
...
const ShoppingProductTile: FC<ShoppingProductTileProps> = ({
  product,
        ...
        <CardContent className="p-4">
          ...
          <div className="flex justify-between items-center mb-2">
            <span className="text-[16px] text-muted-foreground">
              {categoryOptionsMap[product?.category as CategoryOptionKey] ??
                "Unknown Category"}
            </span>
            <span className="text-[16px] text-muted-foreground">
              {brandOptionsMap[product?.brand as BrandOptionKey] ??
                "Unknown Brand"}
            </span>
          </div>
          <div className="flex justify-between items-center mb-2">
